export const cardItem = [
  {
    id: 12,
    projectName: "BuildSmartr — Company Profile",
    iconsList: ["next", "tailwind", "redux", "github", "html"],
    hyperlink: "https://buildsmartr-company-profile.vercel.app/",
    des: "Company profile built with Next.js + Tailwind. Integrated SalesIQ live chat wired to client phone for instant lead handoff, with SEO, analytics, and responsive UX polish.",
    cursorClass: "lala",
  },
  {
    id: 13,
    projectName: "SuperBuilder — RAG Chatbot Portfolio",
    iconsList: ["next", "react", "tailwind", "github", "js"],
    hyperlink: "https://super-builder.ai/",
    des: "Portfolio microsite for a React Native RAG chatbot, showcasing on-device UX, retrieval workflows, and case studies with clean Next.js/Tailwind presentation.",
    cursorClass: "lala",
  },
  {
    id: 14,
    projectName: "I.K Jewellers — Online Store & Booking",
    iconsList: ["next", "psql", "nodejs", "tailwind", "redux"],
    hyperlink: "https://www.ikjewellersltd.com/",
    des: "Jewellery storefront with item booking and customer flow. Next.js front end, Supabase-backed DB (Postgres) with robust CRUD, auth, and admin utilities.",
    cursorClass: "lala",
  },
  {
    id: 15,
    projectName: "XP Desktop — Web OS Experience",
    iconsList: ["next", "react", "tailwind", "js", "html"],
    hyperlink: "https://awshaf-windows-portfolio.vercel.app/",
    des: "A desktop-style portfolio that mimics XP: draggable icons, windowed apps, and playful UI interactions powered by React + motion libraries.",
    cursorClass: "lala",
  },
  // {
  //   id: 1,
